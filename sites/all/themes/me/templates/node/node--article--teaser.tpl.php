<div id="node-<?php print $node->nid; ?>" class="sh-blog <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    ...
    <div class="article-info">
        Forfatter <?php print $name;?>&nbsp;&nbsp;&nbsp;&nbsp;<span class="cdate"><?php print format_date($created,'custom','d M');?></span>&nbsp;&nbsp;&nbsp;&nbsp;Kategori: <?php print render($content['field_tags'])?>
    </div>    
